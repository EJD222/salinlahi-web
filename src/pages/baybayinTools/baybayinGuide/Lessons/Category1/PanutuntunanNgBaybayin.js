            ...
            content: [
              ...
              },
              {
                ...
                tableData: [
                  ["Alpabeto", "Baybayin"],
                  [
                    "Mahal na mahal ni Ding si Narda.",
                    "Mahal na mahal ni Ding si Narda.",
                  ],
        ...
        },
        {
          ...
          dropdownSection: {
            ...
            content: [
              ...
              {
                type: "table_4",
                tableData: [["Ka Pa Ya Pa A N", "kapayapaan"]],
              },
              {
                type: "text",
        ...
        },
        {
          ...
          dropdownSection: {
            ...
            content: [
              ...
              {
                type: "table_2",
                tableData: [["Sabat(+)", "Sinawali(x)", "Pamudpod (᜴)"]],
              },
              {
                type: "question_with_line",
        ...
        },
        {
          ...
          dropdownSection: {
            ...
            content: [
              ...
              {
                type: "text_2",
                text: "Ang danda(,) ay ginagamit bilang pamalit sa bantas na kuwit o comma(,) at ang kapid danda(.) naman ay ginagamit bilang pamalit sa bantas na tuldok o period(.), tandang pananong o question mark(?), at tandang padamdam o exclamation point(!).",
                baybayinWords: {
                  "(,)": "(,)",
                  "(.)": "(.)",
                },
              ...
              },
              {
                ...
                tableData: [
                  [
                    "Kumain ka na. - Pautos (tuldok ang ginagamit)",
                    "Kumain ka na.",
                  ],
                  [
                    "Kumain ka na ba? - Nagtatanong (tandang pananong ang ginagamit)",
                    "Kumain ka na ba?",
                  ],
                ],
              },
              ...
              {
                type: "text",
                text: "Walang katumbas na bantas ang gitling sa Baybayin. Bagkus, pagdikitin lamang ang dalawang salitang hinati ng gitling.",
              ...
              {
                type: "table_4",
                tableData: [["Araw-araw", "araw-araw", "TAMA"]],
              },
              {
                type: "table_4",
                tableData: [
