...
const IkapitongBakas = ({ lessonTitle }) => {
  const [lessonData] = useState({
    ...
    contentBlocks: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine1 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine2 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine3 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine4 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine5 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine6 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideALine7 },
      {
        type: 'table_2',
        tableData: [
          ['Line 7', 'ma na a'],
      ...
      {
        type: 'text',
        text: formatTextWithLineBreaks('Buong nilalaman ng Monreal Stone Side A'),
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine1 },
      {
        type: 'table_2',
        tableData: [
          [
            ...
            formatTextWithLineBreaks('Iwaksi alisin ang nasa isip\nBatiin hanga-an ang mga kalaliman'),
          ],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine2 },
      {
        type: 'table_2',
        tableData: [
          [
            ...
            formatTextWithLineBreaks('Mga kalalimang banayad na lakbayin\nAting mahabang inatin'),
          ],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine3 },
      {
        type: 'table_2',
        tableData: [
          ['Line 3', 'ga ma l da pa ka ya l ha ta', 'Balakang nasadlak wari Ina ng palo'],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine4 },
      {
        type: 'table_2',
        tableData: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine5 },
      {
        type: 'table_2',
        tableData: [
          ['Line 5', 'ba ya I nga a nga ta ha', 'Tunog ng banayad magandang kain'],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine6 },
      {
        type: 'table_2',
        tableData: [
          ['Line 6', 'ba l na ha na ha ba ha pa I ka', 'Dayang nahaan palagay pa siya'],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine7 },
      {
        type: 'table_2',
        tableData: [
          [
            ...
            formatTextWithLineBreaks('Galing babae ngoya tanto lata (Ito ay kagalingan ng isang babae na nagbibigay inspirasyon).'),
          ],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine8 },
      {
        type: 'table_2',
        tableData: [
          ['Line 8', 'ma na sa a ta', 'Bagay hangad natin'],
        ],
      },
      { type: 'image', assetImagePath: BaybayinGuideImages.monrealStoneSideBLine9 },
      {
        type: 'table_2',
        tableData: [
          ['Line 9', 'ngu la ga ta', 'Tulala lata natin'],
        ],
      },
      {
        type: 'text',
        text: formatTextWithLineBreaks('Buong nilalaman ng Monreal Stone Side B'),
