...
const IkalawangBakas = ({ lessonTitle }) => {
  const [lessonData] = useState({
    ...
    contentBlocks: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.lagunaCopperplateInscription1 },
      {
        type: 'text',
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.lagunaCopperplateInscription2 },
      {
        type: 'text',
