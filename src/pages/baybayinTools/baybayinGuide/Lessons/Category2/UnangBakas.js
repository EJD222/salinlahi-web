  ...
  const [lessonData] = useState({
    ...
    contentBlocks: [
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.angonoPetroglyphs1 },
      {
        ...
        boldWords: ['Angono Petroglyphs'] // Only this bold word per example
      },
      {
        type: 'text',
        ...
        // No bold words as per the provided Flutter code
      },
      {
        type: 'table_2',
        tableData: [
      ...
      },
      {
        ...
        boldWords: ['Ano nga ba ang nais iparating ng mga nakaukit sa Angono Petroglyphs?']
      },
      {
        type: 'text',
      ...
      { type: 'image', assetImagePath: BaybayinGuideImages.pregnantWomanOfAngono },
      {
        type: 'text',
