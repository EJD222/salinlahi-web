...
function BaybayinPhrasebook() {
  ...
  const ChildStepping =
    "/assets/icons/baybayin_phrasebook_icons/child_stepping_on_books.png"
    ...
    <div className="baybayin-phrasebook-container">
      ...
      <div className="phrasebook-categories-grid">
        {categories.map((category) => {
          const imagePath = `/assets/icons/baybayin_phrasebook_icons/${category.image}`

          return (
            <div
              key={category.categoryNumber}
              className="phrasebook-category-card"
            >
              <Link
