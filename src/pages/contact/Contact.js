...
const Contact = () => {
  const form = useRef();
  const [messageStatus, setMessageStatus] = useState(''); // State to hold success/failure message

  const sendEmail = (e) => {
    e.preventDefault();

    emailjs
      .sendForm('service_f18g0bk', 'template_3syerkt', form.current, 'SVWO5SHc7BEHyAQK1')
      .then(
        () => {
          setMessageStatus('Message sent successfully!'); // Set success message
        ...
        (error) => {
          setMessageStatus('Message failed to send. Please try again.'); // Set failure message
    ...
    <div className="contact-us-form-container">
      <div className="contact-container">
        ...
        <div className="contact-form">
          ...
          {messageStatus && <p className="message-status">{messageStatus}</p>} {/* Display message */}
        </div>
        ...
        <div className="contact-details">
          ...
          <div className="contact-info">
              ...
              <a href="https://www.facebook.com/Awanggan052120" 
                target="_blank" 
